...
SetupVnetForSubnetDelegation -virtualNetworkSubscriptionId $subscriptionId `
    -virtualNetworkName $vNetNameAE `
    -subnetName $vNetSubnetNameAE
SetupVnetForSubnetDelegation -virtualNetworkSubscriptionId $subscriptionId `
    -virtualNetworkName $vNetNameASE `
    -subnetName $vNetSubnetNameASE